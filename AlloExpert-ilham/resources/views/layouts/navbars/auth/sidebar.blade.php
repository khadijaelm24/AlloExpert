<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard_client') }}">
          <img src="/alloexpert/assets/images/logo1.png" class="navbar-brand-img h-100" alt="...">
          <span class="ms-3 font-weight-bold">AlloExpert</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('dashboard_client') ? 'active' : '') }}" href="{{ url('dashboard_client') }}">
          ...
          <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }} " href="{{ route('profile') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      ...
                      <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="nonzero">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="fas fa-lg fa-file-alt ps-2 pe-2 text-center text-dark" aria-hidden="true"></i>
              </div>
              <span class="nav-link-text ms-1">Consulter demande</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('services.create') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <i class="fas fa-lg fa-tools ps-2 pe-2 text-center text-dark" aria-hidden="true"></i>
              </div>
              <span class="nav-link-text ms-1">Demander service</span>
          </a>
        </li>
