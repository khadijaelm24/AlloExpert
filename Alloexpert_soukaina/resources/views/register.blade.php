    ...
    <div style=" margin-left:130px; height:400px;" >
        <div class="col-xl-4 col-lg-7 col-md-5">
            ...
            <form role="form text-left" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                <br>
                <label for="user_type" class="form-label" style="color: black ;">Je suis :     </label>
                <select class="form-select" id="user_type" name="user_type">
                  <!-- Ajouter ici pour choisir -->

                  <option value="choisir">Chosir</option>
              ...
              <div class="client-fields" style="display: none; color:black" > <!-- Conditional client fields -->
                ...
                <div class="mb-3">
                  <label for="prenom_cl">Prénom: </label>
                ...
                <div class="mb-3">
                  <label for="photo_cl"> Photo :</label>
              ...
              <div class="partner-fields" style="display: none; color:black"> <!-- Conditional partner fields -->
                ...
                <div class="mb-3">
                  <label for="photo_par">Photo:</label>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="" aria-label="Métier" aria-describedby="metier-addon" name="metier" id="metier">
                </div>
                <div class="mb-3">
                  <label style="color :black;" for="nbr_experience"> Nombre d'années d'expérience:</label>
                ...
                <div class="mb-3">
                  ...
                  <div multiple class="form-select" id="domaine_expertise" name="domaine_expertise">

                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="jardinage" name="domaine_expertise[]" value="jardinage">
                            <label class="form-check-label" for="jardinage">Jardinage</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="menage" name="domaine_expertise[]" value="menage">
                            <label class="form-check-label" for="menage">Ménage</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="cuisine" name="domaine_expertise[]" value="cuisine">
                            <label class="form-check-label" for="cuisine">Cuisine</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="bricolage" name="domaine_expertise[]" value="bricolage">
                            <label class="form-check-label" for="bricolage">Bricolage</label>
                        </div>
